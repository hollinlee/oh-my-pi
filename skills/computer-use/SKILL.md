...
name: computer-use
description: >-
  Use Orca computer-use CLI for OS/window-level inspection and input in visible
  local app windows. Use when a task must read or operate a native app or an
  external browser window (e.g. Chrome, Edge, Safari) or an app webview. For
  Orca embedded pages use orca-cli; for external page automation use Playwright
  or CDP.
---
