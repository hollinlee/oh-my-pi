...
test("budget presets match the public contract", () => {
  assert.deepEqual(BUDGETS.small, { turns: 6, toolCalls: 12, wallTimeMs: 180_000, providerIdleMs: 120_000 });
  assert.deepEqual(BUDGETS.standard, { turns: 15, toolCalls: 40, wallTimeMs: 600_000, providerIdleMs: 180_000 });
  assert.deepEqual(BUDGETS.large, { turns: 30, toolCalls: 100, wallTimeMs: 1_800_000, providerIdleMs: 300_000 });
});
